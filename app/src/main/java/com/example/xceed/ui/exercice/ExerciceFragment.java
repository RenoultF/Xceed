...
public class ExerciceFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        //ajout des exercice
        listExercice.add(new Exercice("Developpé couché (Barre)","Ceci est du dev Couch",R.drawable.gif_dc,"Pectoraux",4,12,R.drawable.img_dev_couch));
        listExercice.add(new Exercice("Developpé couché incliné (Barre)","Ceci est du dev Couch incliné",R.drawable.gif_devinc,"Pectoraux (Haut)",4,12,R.drawable.dev_couch_incline));
        listExercice.add(new Exercice("Developpé couché décliné (Barre)","Ceci est du dev Couch décliné",R.drawable.gif_devdec, "Pectoraux (Bas)",4,12,R.drawable.dev_couch_decli));
        listExercice.add(new Exercice("Pompe","Ceci est des pompe",R.drawable.gif_pompes, "Pectoraux",4,12,R.drawable.pompe));
        listExercice.add(new Exercice("Ecarté (Haltere)","Ceci est de l'écarté",R.drawable.gif_ecarte, "Pectoraux",4,12,R.drawable.ecarte_haltere));
